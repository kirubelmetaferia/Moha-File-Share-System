...
export default function ForceChangePassword() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setStatus("error");
      setMessage(err.response?.data?.error || "Failed to change password. You may need to log in again.");
    }
  }
      ...
      <div className="lg:col-span-3 flex flex-col items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-foreground">Action Required</h2>
            <p className="text-sm text-muted-foreground">
              Your password has been reset by an administrator or you are logging in for the first time. You must set a new password to continue.
            </p>
          </div>
          ...
          {status === "success" ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                disabled={!isFormValid || !tempToken}
